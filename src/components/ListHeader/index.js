  ...
  if (mode == "excelModal") {
    ...
    extraButtons = (
      <>
        ...
        <SoftButton
          variant="outlined"
          onClick={() => (location.href = "http://206.189.239.87:4000/v1/sale/excelWeb")}
          color="info"
          size="small"
        >
          Descargar Ventas
    ...
    extraButtons = (
      <>
        ...
        <SoftButton
          variant="outlined"
          onClick={() => (location.href = "http://206.189.239.87:4000/v1/sale/excelPos")}
          color="info"
          size="small"
        >
          Descargar Ventas
    ...
    /* extraButtons += (
      <SoftButton
        variant="outlined"
        onClick={() => goUrl("http://206.189.239.87:4000/v1/factura/receivedDte")}
        color="info"
        size="small"
      >
        Descargar Todas
    ...
    extraButtons = (
      <>
        <SoftButton
          variant="outlined"
          onClick={() =>
            goUrl(`${process.env.REACT_APP_INVENTARIO_API_URL}factura/exportFromExcel/Pagada`)
          }
          color="dark"
          size="small"
        >
        ...
        <SoftButton
          variant="outlined"
          onClick={() =>
            goUrl(`${process.env.REACT_APP_INVENTARIO_API_URL}factura/exportFromExcel/No_Pagada`)
          }
          color="dark"
          size="small"
        >
          Descargar No Pagadas
        </SoftButton>
        <SoftButton
          variant="outlined"
          onClick={() =>
            goUrl(`${process.env.REACT_APP_INVENTARIO_API_URL}factura/exportFromExcel/Todas`)
          }
          color="dark"
          size="small"
        >
        ...
        <SoftButton
          variant="outlined"
          onClick={() => goUrl(`${process.env.REACT_APP_INVENTARIO_API_URL}factura/receivedDte`)}
          color="info"
          size="small"
        >
          Actualizar
