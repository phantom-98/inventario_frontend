        ...
        return (
          <>
            ...
            <SoftButton
              variant="text"
              style={color}
              onClick={(e) => onDelete(tableMeta.rowData[8])}
            >
        ...
        return (
          <>
            <SoftButton
              variant="text"
              style={color}
              onClick={(e) => edit(tableMeta.rowData[index])}
            >
              <Tooltip title="editar">
                <Icon>edit</Icon>
              </Tooltip>
            ...
            <SoftButton
              variant="text"
              style={color}
              onClick={(e) => onDelete(tableMeta.rowData[index])}
            >
        ...
        return (
          <>
            ...
            <SoftButton
              variant="text"
              style={color}
              onClick={(e) => onDelete(tableMeta.rowData[4])}
            >
              <Tooltip title="eliminar">
                <Icon>delete</Icon>
              </Tooltip>
